    ...
    public class UnitOfWork
    {
        ...
        private void temporaryInitialise()
        {
            Apartments = new()
            {
                ...
                new(){ CreatorId=2, Description="This is an expensive apartment", Id=2, ImageSrc="https://images.pexels.com/photos/2121120/pexels-photo-2121120.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1/", Name="Bucharest apartment", Price=3000,Link = "", CompanyName="Siemens", Location="Bucharest"},
            };
            ...
            Jobs = new()
            {
                ...
                new(){ CreatorId=2, Description="Well payed job", Id=2, ImageSrc="https://media.hotnews.ro/media_server1/image-2020-06-9-24045732-41-programator.jpg", Name="Brasov Job Offer", Price=3000, Link = "https://www.ejobs.ro/user/locuri-de-munca/junior-software-developer-erp-software/1734603", CompanyName="Siemens", Location = "Brasov"},
            };
            Vehicles = new()
            {
                ...
                new(){ CreatorId=2, Description="This is an expensive apartment", Id=2, ImageSrc="https://media2.lajumate.ro/media/i/cart/5/125/12533305_renault-trafic19-diesel2006acfinantare-rate_8.jpg", Name="Bucharest van", Price=1000,Link = "https://www.rent-a-duba.ro/", CompanyName="Siemens", Location="Bucharest"},
            };
            Transports = new()
            {
                ...
                new(){ CreatorId=2, Description="Expensive travel", Id=2, ImageSrc="https://scontent.fsbz3-1.fna.fbcdn.net/v/t39.30808-6/393409316_635211942112397_2548563276938212288_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=L96YY5zI7W8AX96_lu9&_nc_ht=scontent.fsbz3-1.fna&oh=00_AfAecj1e_Oq8zT-CZzGnm1wJhZuCVCcg3x3BmRTCn4LEJw&oe=65ADFCC8", Name="Bucharest van", Price=1000,Link = "https://www.autogari.ro/Transport/Iasi-ClujNapoca", CompanyName="Siemens", Location="Bucharest"},
            };
            Users = new()
            {
            ...
            IndustryUsers = new()
            {
                new(){Id=1, Name="Bill Gates", UserId=2, CompanyName="Rolemus", Email="gates@money.com"},
                new(){Id=2, Name="Ramona Montana", UserId=3,CompanyName="Siemens", Email="idk@yikes.com"}
            };
            Emails = new()
            {
